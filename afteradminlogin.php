...
function selectSuggestion(suggestion) {
  ...
  <body>
		...
		<nav class="navbar-nav navbar-expand-sm bg-info1" style="margin:0px;padding:0px;">
...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:20px 2px 0px 20px;color:white"></i>
		...
		<!--<img src="admin.png" style="border-radius:15%;margin-left:0%;float:left" width="70px" height="80px">-->
				...
				<div style="width:50%" >
				<a class="btn btn-danger" style="float:right;padding-left:30px;padding-right:30px;margin:10px;" href="usertype.html">Logout</a>
		</div>
    ...
    <div id="file3" class="col-lg-3 col-md-6" onclick="completed()" style="cursor:pointer;">
        ...
        <div class="search-container">
							...
							while($row=mysqli_fetch_assoc($result))
								{				
										...
										if($id==$inid)
										{
											...
											<input type='text' name='user' value='$usr' class='now'>
											<input type='text' name='compid' value='$id' class='now'>
											<input type='submit' name=complete_complaint' value='complete it' style='float:right;margin:0px;' class='btn btn-secondary' >
											</form>
			...
			<div class="" id="complcomp" style="width:97%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:white">
			...
			<div class="" id="fullhistory" style="width:97%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:white">
